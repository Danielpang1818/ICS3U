...
public class Student {
    ...
    // Constructor -> create the object and set the initial state (give the attributes initial values)
    // arguments are in the (round brakets) they are required for the function/method for java - to execute
